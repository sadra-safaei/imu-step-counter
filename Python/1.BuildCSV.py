...
THRESHOLD_HEIGHT = 1.03  # Peak height threshold
MIN_DISTANCE_SEC = 0.35  # Minimum time between consecutive steps in seconds


def lowpass_filter(data, cutoff, fs, order=3):
    """Applies a zero-phase Butterworth low-pass filter to the input data."""
    nyquist = 0.5 * fs
...
def main():
    ...
    try:
        ...
        # --- PLOT 2: FILTERED SIGNAL COMPARISON ---
        ...
        # --- PLOT 3: DETECTED STEPS & THRESHOLD ---
        plt.figure(figsize=(12, 5))
